...
namespace ClientApp
{
    public partial class MainForm : Form
    {
        ...
        private void BuildUi()
        {
            ...
            // Logo trường ở góc trái cùng. Load từ file ảnh trong thư mục Assets kèm
            // theo project (không tự vẽ lại) — nếu vì lý do gì đó không tìm thấy file,
            // bỏ qua trong im lặng để không làm crash cả app chỉ vì thiếu logo.
